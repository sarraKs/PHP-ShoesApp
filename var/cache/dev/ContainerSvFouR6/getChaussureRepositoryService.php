 ...
 */
class getChaussureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChaussureRepository' shared autowired service.
     *
     * @return \App\Repository\ChaussureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChaussureRepository.php';

        return $container->privates['App\\Repository\\ChaussureRepository'] = new \App\Repository\ChaussureRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
