...
class __TwigTemplate_660810521b2a48745aaf923feaa287fc extends Template
{
    private $source;
    private $macros = [];
...
<div>
Voici tous les placards:
<ul>
  
  ";
        // line 13
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["placards"]) || array_key_exists("placards", $context) ? $context["placards"] : (function () { throw new RuntimeError('Variable "placards" does not exist.', 13, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["placard"]) {
            // line 14
            echo "  <li> <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("placard_show", ["id" => twig_get_attribute($this->env, $this->source, $context["placard"], "id", [], "any", false, false, false, 14)]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["placard"], "NomPlacard", [], "any", false, false, false, 14), "html", null, true);
            echo "</a></li>
  ";
        }
...
Appuyez sur un placard pour plus de details.
</div>
