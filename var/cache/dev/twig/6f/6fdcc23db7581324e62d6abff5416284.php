...
class __TwigTemplate_7f176183fb3e9e7c49e49f50fea9b9d0 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 4
        echo "      <h1>Details du Placard ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["placard"]) || array_key_exists("placard", $context) ? $context["placard"] : (function () { throw new RuntimeError('Variable "placard" does not exist.', 4, $this->source); })()), "id", [], "any", false, false, false, 4), "html", null, true);
        echo "</h1>
      ...
      <a href=\"";
        // line 41
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("Placard_list");
  ...
  ";
    ...
    {
        return array (  137 => 41,  128 => 34,  117 => 32,  114 => 31,  110 => 30,  101 => 24,  94 => 20,  87 => 16,  80 => 12,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
      <h1>Details du Placard {{ placard.id }}</h1>
      ...
      <a href=\"{{ path('Placard_list') }}\">Revenir à la liste</a>
