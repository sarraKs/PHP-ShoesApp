 ...
 */
class getPlacardRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlacardRepository' shared autowired service.
     *
     * @return \App\Repository\PlacardRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlacardRepository.php';

        return $container->privates['App\\Repository\\PlacardRepository'] = new \App\Repository\PlacardRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
